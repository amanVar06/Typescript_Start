...
//how to annotate props in object
// we defined type for objects in advance
type Guitarist = {
  name?: string;
  active: boolean; //we can add an optional property by adding ? before :
...
enum Grade {
  U = 1, //change the top/starting one i.e. U then everything will adapt
  D,
  C,
  B,
  A,
